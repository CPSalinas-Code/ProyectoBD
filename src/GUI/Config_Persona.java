 ...
 * @author Christian
 */
public class Config_Persona extends javax.swing.JFrame {

    public Administrador admin;
    public DefaultTableModel modelo;

    /**
     * Creates new form Config_Persona
     */
    public Config_Persona() {

        initComponents();
        admin = new Administrador();
        modelo = new DefaultTableModel();
        txtPrueba.setEditable(false);
        this.setTitle("Configuracion de Registros de la Tabla Persona");
        this.setSize(695, 305);
    ...
    private void initComponents() {
        ...
        tablaPersonas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Persona", "Nombre", "Apellido", "Direccion", "Telefono", "Fecha Nacimiento"
            }
        ));
        ...
        jScrollPane1.setBounds(10, 11, 671, 193);
        ...
        txtPrueba.setBounds(500, 210, 182, 23);
        ...
        btnEliminar.setBounds(308, 244, 182, 23);
        ...
        btnEditar.setBounds(496, 244, 185, 23);
        ...
        btnSalir.setBounds(10, 244, 280, 23);
    ...
    public void actualizar() {
        ...
        numeroDeRegistros = admin.numeroReg("Personas");
        if (numeroDeRegistros == 0) {
            JOptionPane.showMessageDialog(null, "Error al contar los registros de la tabla Personas o no tiene Permisos en esta tabla con el usuario actual");
            this.setVisible(false);
        } else {
            this.setVisible(true);
            try {
                while (numeroDeRegistros > 0) {
                    objeto = admin.obtenerDatosPersona(cont);
                ...
                tablaPersonas.isCellEditable(0, 5);
                tablaPersonas.setColumnSelectionInterval(2, 3);
            } catch (Exception e) {
                System.out.println("ERROR AL OBTENER LOS DATOS de Personas");
                JOptionPane.showMessageDialog(null, "ERROR AL OBTENER LOS DATOS de Personas");
            }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        } else if (admin.eliminarReg(clav, "Personas")) {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String clav = txtPrueba.getText();
        if (clav.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Campo de ID no Seleccionado 0 ID no valido");
        } else {
            EditarPersona ventana = new EditarPersona(clav, "Personas", this);
            //admin.editarReg();
            //actualizar();
        }
    ...
    private void tablaPersonasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaPersonasMouseClicked
        ...
        int col = tablaPersonas.getSelectedColumn();
        String id = tablaPersonas.getValueAt(row, col).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Config_Persona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Config_Persona().setVisible(true);
            }
        });
    }
